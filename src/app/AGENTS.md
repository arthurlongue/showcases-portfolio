...
- **Routing Structure**: Follow Next.js App Router conventions (`page.tsx`, `layout.tsx`). Organize routes by niche under `/premium/[niche]`. Keep Client Components (`"use client"`) strictly at the leaves.
